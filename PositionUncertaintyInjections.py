...
jobName =  "PUn_" + str(freq) + "_" + str(cosi)
					...
					for step in xrange(0,101):
						...
						for d in xrange(0,4):
							...
							CFSoutputDir = CFSlocation + "/" + directionlist[d] + "_cosi_" + str(cosi) + "_freq_" + str(freq)
							...
							Vars['CFSOutput'] = CFSoutputDir + "/"+ directionlist[d] + "_cosi_" + str(cosi) + "_freq_" + str(freq) + "_"+str(step)+".dat"
